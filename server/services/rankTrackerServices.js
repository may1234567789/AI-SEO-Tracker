...
export async function rankTracker(keyword, targetDomain) {
    ...
    try {
        ...
        for (let gpage = 0; gpage < 5; gpage++) {
            ...
            if (found) break;
            await page.waitForTimeout(2000 + Math.random() * 2000); // Random wait between 2-4 seconds before next page
        }

        // 6. Finalization: Close the browser and return the results
        await browser.close();
        ...
        console.error("Error in rankTracker:", error);
        if (browser) {
